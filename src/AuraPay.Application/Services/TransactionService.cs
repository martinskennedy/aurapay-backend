...
namespace AuraPay.Application.Services
{
    internal class TransactionService : ITransactionService
    {
        ...
        {
            // 1. Buscar conta de origem pelo UserId (quem está logado)
            ...
            // 2. Buscar conta de destino pelo Id informado
            ...
            // 3. Executar a lógica de negócio (Regras de Domínio)
            // O domínio valida se há saldo suficiente
            originAccount.Withdraw(request.Amount);
            destinationAccount.Deposit(request.Amount);

            // 4. Criar os registros de extrato (Auditoria)
